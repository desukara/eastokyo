...
function Caption({ children }: { children: React.ReactNode }) {
  return <figcaption className={styles.caption}><span className={styles.captionLead}>{children}</span><span className={styles.credit}>{credit}</span></figcaption>;
}
    ...
    <main id="top" className={styles.page}>
      ...
      <section className={styles.featureOne}>
        <figure>
          ...
          <Caption>LOOKING IS NEVER PASSIVE. YOU BRING YOURSELF INTO THE ROOM.</Caption>
        </figure>
      </section>
      ...
      <section className={styles.bodyBeat}>
        ...
        <div className={`${styles.prose} ${styles.openingA}`}>
          ...
          <p className={styles.shortBeat}>There is not one cloud in the sky.</p>
          ...
          <p className={styles.shortBeat}>Then I remember where I am.</p>
          <p className={styles.shortBeat}>It's a sunbrella.</p>
          <p className={styles.shortBeat}>I made that word up. And I'm keeping it.</p>
          ...
          <p className={styles.shortBeat}>But I grew up knowing what an umbrella was for.</p>
          <p className={styles.shortBeat}>Rain. Filed away. Done.</p>
        ...
        <div className={`${styles.prose} ${styles.openingB}`}>
          ...
          <p className={styles.shortBeat}>That's a hard thing to pull off with Pablo Picasso.</p>
          ...
          <p className={styles.shortBeat}>We know Picasso.</p>
        </div>

        <blockquote className={styles.sideQuote}>WE KNOW PICASSO. THEREIN LIES THE PROBLEM.</blockquote>

        <div className={`${styles.prose} ${styles.openingC}`}>
          <p className={styles.shortBeat}>And that is exactly the problem.</p>
      ...
      <section className={styles.harlequin}>
        <figure className={styles.harlequinFigure}>
          ...
          <Caption>THE WALL IS NOT BACKGROUND ANYMORE. IT HAS ENTERED THE CONVERSATION.</Caption>
        </figure>
        ...
        <div className={styles.harlequinLead}>
          ...
          <div className={styles.prose}>
            ...
            <p className={styles.shortBeat}>He doesn't touch the Picasso. He touches the room around it.</p>
            ...
            <p className={styles.shortBeat}>And the paintings answer back.</p>
            ...
            <p className={styles.shortBeat}>But something moves. We move.</p>
        ...
        <div className={styles.harlequinAfter}>
          ...
          <div className={`${styles.prose} ${styles.harlequinRest}`}>
            ...
            <p className={styles.questionBeat}>Where does the artwork actually end?</p>
            <p>At the edge of the canvas? The wall? The room? The person standing in front of it? The museum door?</p>
            <p className={styles.shortBeat}>Good luck drawing that line.</p>
          </div>
        </div>
      </section>
      ...
      <section className={styles.blueAct}>
        <div className={styles.blueInner}>
          ...
          <figure className={styles.blueFigure}>
            ...
            <Caption>ANOTHER LAYER DOES NOT ERASE THE FIRST ONE. SOMETIMES IT HELPS YOU SEE IT.</Caption>
          </figure>
      ...
      <section className={styles.quiet}>
        <div className={styles.quietHead}>
          ...
          <div className={styles.prose}>
            ...
            <p className={styles.shortBeat}>Meaning stays alive because the looking stays alive.</p>
          </div>
        </div>
        ...
        <div className={styles.quietMiddle}>
          ...
          <p className={styles.worlds}>There are worlds inside worlds. A painting can hold a room. A room can hold a city. A city can hold a few million private lives, all brushing against one another.</p>
          <div className={styles.prose}>
        ...
        <figure className={styles.thresholdFigure}>
          ...
          <Caption>THE FRAME ENDS. THE LOOKING DOES NOT.</Caption>
        </figure>
        ...
        <div className={styles.quietFinal}>
          <div className={`${styles.prose} ${styles.finalMain}`}>
            ...
            <p className={styles.shortBeat}>That's a habit worth stealing.</p>
            ...
            <p className={styles.objectList}>A bicycle seat. A face. A stripe. A ceramic plate. An umbrella under a sky with no rain in it.</p>
