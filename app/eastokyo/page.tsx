...
const contents = [
  { href: "#bullfighting", section: "1. COVER ARTICLE", title: "HE KEPT WALKING BACK IN.", copy: "Picasso returned to that arena again and again, because it never stopped giving him something new to feel and to paint." },
  { href: "#exhibition", section: "2. EXHIBITION", title: "PICASSO, LOOKED AT AGAIN.", copy: "Paul Smith changes the room, and suddenly Picasso wakes up in it." },
  { href: "#cubism", section: "3. IDEAS", title: "WHEN A SINGLE ANGLE WAS NO LONGER ENOUGH.", copy: "Picasso and Braque decided that an image was not obliged to remain well-behaved and still. Neither were they. Bien sûr." },
  ...
  { href: "#picasso-index", section: "5. INDEX", title: "NOTHING IS EVER QUITE WHAT IT SEEMS TO BE.", copy: "Faces reworked until they told the truth. Ceramics turned into another canvas. Bicycle parts transformed into something entirely different once they had passed through his hands. Picasso was simply incapable of leaving a good idea alone. Dieu merci." },
];
...
const indexStories = [
  ...
  { section: "STRIPES", title: "PAUL SMITH LEAVES HIS MARK.", copy: "Paul Smith turns a simple stripe into part of the exhibition’s rhythm, a discreet presence running quietly from room to room." },
  { section: "CERAMICS", title: "PICASSO NEVER REALLY FINISHED HIS PLATE.", copy: "He turned the dining table into another studio, because he never really knew how to stop working and, deep down, he did not really want to." },
];

const asagayaImages = [
  { src: "/images/editorial/la-ciudad-despierta-desktop.png", label: "THE STREET IS ALREADY AWAKE. IT IS NOT GOING TO WAIT FOR YOU." },
  ...
  { src: "/images/editorial/tokio-no-es-gris-asagaya-lanterns.png", label: "LANTERNS EVERYWHERE YOU LOOK." },
