...
const asagayaImages = [
  ...
  { src: "/images/editorial/tokio-no-es-gris-mona-lisa-tanabata.png", label: "EVEN MONA LISA SHOWED UP" },
  { src: "/images/editorial/ritmo-urbano-giraffe-desktop.png", label: "LOOK UP. WAY UP." },
  { src: "/images/editorial/todo-vivos-desktop.jpg", label: "EVERYBODY’S HANGING OUT" },
...
export default function EastokyoHome() {
  ...
  return <div className="mag-page" id="top">
    ...
    <div id="mag-mobile-menu" className={`mag-mobile-menu ${menuOpen ? "is-open" : ""}`} role="dialog" aria-modal="true" aria-label="Issue menu" aria-hidden={!menuOpen}>
      ...
      <p>EASTOKYO · Nº 01 · MADE IN TOKYO.</p>
    </div>
    ...
    <main id="contenido">
      ...
      <section className="cubism-spread" id="cubism-works" aria-labelledby="cubism-spread-title">
        ...
        <div className="cubism-slot-grid">
          ...
          <ImageSlot number="02" title="OWL · PICASSO · NIGHT VISION" />
      ...
      <section className="mag-back-cover" id="about" aria-labelledby="about-title">
        <div className="mag-back-inner">
          <div className="mag-mini-cover" aria-label="Preview of EASTOKYO inaugural issue"><EditorialImage src="/images/editorial/picasso-bullfight-01-desktop.png" alt="" sizes="(max-width: 640px) 70vw, 20rem" /><strong>EASTOKYO</strong><h3>HE NEVER REALLY LEFT THE ARENA.</h3><p>Nº 01 · TOKYO · SEPTEMBER 2026</p></div>
          <div className="mag-back-copy"><p className="mag-kicker">EASTOKYO · Nº 01 · MADE IN TOKYO</p><h2 id="about-title">ART FROM TOKYO, LOOKING EVERYWHERE.</h2><p>EASTOKYO is an independent art magazine for people who like their art alive.</p><span className="mag-back-date">01 · 09 · 2026 · Nº 01 · JUST GETTING STARTED</span></div>
        </div>
      </section>
    </main>

    <footer className="mag-footer">
      <div className="mag-footer-top"><div><p className="mag-kicker">EASTOKYO · Nº 01</p><h2>LOOK AGAIN.</h2></div><div className="mag-newsletter"><p>THE EASTOKYO LETTER · DON’T MISS THE NEXT ONE</p><strong>NOT YET. BUT SOON.</strong></div></div>
      ...
      <div className="mag-footer-bottom"><p>© 2026 EASTOKYO · TOKYO, JAPAN</p><p>MADE IN TOKYO · READY FOR MORE</p><a href="#top">ONE MORE LOOK ↑</a></div>
    </footer>
  </div>;
}