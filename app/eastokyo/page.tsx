...
const contents = [
  { href: "#bullfighting", section: "1. COVER ARTICLE", title: "HE KEPT GOING BACK THERE WITHOUT END.", copy: "Picasso went back into that arena again and again, because it never stopped giving him something new to feel and to paint." },
    ...
    <main id="contenido">
      <section className="mag-cover" id="latest" aria-labelledby="cover-title">
        ...
        <div className="mag-cover-grid">
          ...
          <div className="mag-cover-lines" aria-label="Featured stories in this issue">
            ...
            <article className="mag-cover-line"><div><small>IDEAS</small><p>THE MOMENT WHEN A SINGLE ANGLE SIMPLY WAS NO LONGER ENOUGH TO CONTAIN EVERYTHING HE HAD TO SAY.</p></div></article>
            <article className="mag-cover-line"><div><small>TOKYO</small><p>THE CITY PUTS ON ITS COSTUME, AND IT DOES NOT APOLOGIZE FOR IT FOR A SECOND.</p></div></article>
          </div>
        </div>
      ...
      <section className="mag-section mag-contents" id="contents" aria-labelledby="contents-title">
        ...
        <div className="mag-contents-grid">
          <div className="mag-contents-title"><p className="mag-kicker">THIS IS WHERE THE RHYTHM REALLY SPEEDS UP.</p><h2 id="contents-title">FIVE STORIES. ONE ISSUE. LOOK TWICE.</h2></div>
      ...
      <section className="mag-section mag-feature" id="bullfighting" aria-labelledby="bullfighting-title">
        <div className="mag-feature-grid">
          <header className="mag-feature-heading"><p className="mag-kicker">COVER ARTICLE. PICASSO, IN THE ARENA.</p><h2 id="bullfighting-title">HE KEPT GOING BACK THERE WITHOUT END.</h2></header>
      ...
      <section className="mag-section mag-front picasso-feature" id="exhibition" aria-labelledby="front-title">
        ...
        <div className="picasso-feature-intro">
          <div className="picasso-feature-title"><p className="mag-kicker">REVIEW. TOKYO MEETS PICASSO.</p><h3 id="front-title">PICASSO, LOOKED AT AGAIN.</h3><p className="mag-deck">Paul Smith moves the walls, and Picasso wakes up in that room after years of waiting for someone, anyone, to finally open the door.</p><StoryCta story="exhibition" /></div>
          <aside className="picasso-feature-note"><strong>PICASSO, ROOM AFTER ROOM.</strong><p>You move forward with him from one room to another, and you feel something happening. Each space quietly changes the way the next work reaches us, until you find yourself, right at the very end, facing something that stops you dead.</p></aside>
        </div>
      ...
      <section className="cubism-intro" id="cubism" aria-labelledby="cubism-title">
        ...
        <div className="cubism-intro-copy">
          ...
          <h2 id="cubism-title">A SINGLE ANGLE WAS NO LONGER ENOUGH.</h2>
          <p>Picasso and Braque took a single, very docile vision of the world and opened it up completely, because one calm angle could never contain all the life they wanted to put into an image. At first, the result was not necessarily easy to look at. Truly honest things rarely are. But it gets under your skin and stays there long after you have looked away. Cubism forces you to do part of the work yourself. The image opens up piece by piece, and that is exactly how it should work.</p>
          <StoryCta story="ideas" />
        </div>
        <div className="cubism-intro-note"><span>1907.</span><p>The year when perspective splits in two and an image stops pretending to be a window onto the world. It becomes a constructed thing, with its own weight and its own beat.</p></div>
      </section>
      ...
      <section className="cubism-spread" id="cubism-works" aria-labelledby="cubism-spread-title">
        <div className="cubism-spread-head">
          ...
          <p>Cubism begins by refusing to let a painting remain still or imprisoned by a single point of view on the world, and these four works show how far Picasso and Braque were prepared to push that idea.</p>
        </div>
        <div className="cubism-slot-grid">
          <ImageSlot number="01" title="CUBISM. A SINGLE POINT OF VIEW? NEVER AGAIN." />
          <ImageSlot number="02" title="OWL. EYES WIDE OPEN IN THE DARK, WATCHING EVERYTHING." />
          <ImageSlot number="03" title="STILL LIFE, BUT BARELY STILL ANYMORE." />
          <ImageSlot number="04" title="PORTRAIT. THE TRUTH OF A FACE." />
        </div>
        <div className="cubism-spread-foot"><p>Here, objects and bodies stop obeying perspective. Picasso breaks them into planes, turns them through space, then rebuilds them piece by piece across the surface.</p><div>A SINGLE POINT OF VIEW COULD NEVER HAVE CONTAINED EVERYTHING. THAT WAS ALREADY THE WHOLE POINT, AND IT STILL IS.</div></div>
      </section>

      <section className="mag-section mag-photo" id="asagaya" aria-labelledby="photo-title">
        <div className="mag-photo-head"><p className="mag-kicker">TOKYO. TANABATA IN ASAGAYA.</p><h2 id="photo-title">THE CITY PUTS ON ITS COSTUME.</h2><p>Paper creatures float above people’s heads, and the street tips into celebration without asking anyone’s permission.</p><StoryCta story="tokyo" /></div>
      ...
      <section className="mag-section mag-index" id="picasso-index" aria-labelledby="show-title">
        <div className="mag-index-head"><div><p className="mag-kicker">INDEX. PICASSO. START WHEREVER YOU WANT.</p><h2 id="show-title">NOTHING IS EVER QUITE WHAT IT SEEMS TO BE.</h2><StoryCta story="index" /></div><p>Faces taken apart and then rebuilt. Ceramics crossed through by the same nervous energy as his paintings. Bicycle parts that, suddenly, look less like machinery than sculpture. Picasso had the gift of making the ordinary seem freshly invented, and that is exactly why we keep coming back to it.</p></div>
      ...
      <section className="mag-back-cover" id="about" aria-labelledby="about-title">
        <div className="mag-back-inner">
          <div className="mag-mini-cover" aria-label="Preview of EASTOKYO inaugural issue"><EditorialImage src="/images/editorial/picasso-bullfight-01-desktop.png" alt="" sizes="(max-width: 640px) 70vw, 20rem" /><strong>EASTOKYO</strong><h3>HE KEPT GOING BACK THERE WITHOUT END.</h3><p>NUMBER ONE. TOKYO. SEPTEMBER 2026.</p></div>
          <div className="mag-back-copy"><p className="mag-kicker">EASTOKYO. NUMBER ONE.</p><h2 id="about-title">TOKYO ART. EYES OPEN.</h2><p>EASTOKYO is an independent art magazine for those who need art to truly have a pulse — not something you choose to go with the sofa, but something you can almost feel moving when you hold the pages in your hands.</p><span className="mag-back-date">NUMBER ONE. WE ARE ONLY JUST GETTING STARTED, AND WE ARE NOT GOING TO SLOW DOWN FOR ANYONE.</span></div>
        </div>
      </section>
    </main>

    <footer className="mag-footer">
      <div className="mag-footer-top"><div><p className="mag-kicker">EASTOKYO. NUMBER ONE.</p><h2>LOOK TWICE.</h2></div><div className="mag-newsletter"><p>THE EASTOKYO LETTER. DO NOT MISS THE NEXT ONE.</p><strong>NOT YET. BUT SOON. WE PROMISE YOU, AND WE REALLY MEAN IT.</strong></div></div>
