...
const contents = [
  ...
  { href: "#exhibition", section: "2. EXHIBITION", title: "PICASSO, LOOKED AT AGAIN.", copy: "Paul Smith moves the walls around, and just like that, Picasso is wide awake in the room, like he never really left it." },
    ...
    <main id="contenido">
      ...
      <section className="mag-section mag-feature" id="bullfighting" aria-labelledby="bullfighting-title">
        <div className="mag-feature-grid">
          ...
          <div className="mag-feature-copy"><p className="mag-deck">That arena got its hooks into him early, and it never really let him go. Every time Picasso walked back in, the ring showed him something it hadn't shown him before, some new shade of fear or grace or violence, and he took every bit of it straight to the canvas, like he couldn't wait to get it out of himself.</p><p className="mag-feature-columns">In that ring you watch the whole animal in a person come loose, fear and all, nothing held back and nowhere to hide it. That's exactly why he loved it there. A place that honest doesn't come around often. When it does, you don't waste it, and you certainly don't turn your back on it.</p></div>
      ...
      <section className="mag-section mag-front picasso-feature" id="exhibition" aria-labelledby="front-title">
        ...
        <div className="picasso-gallery-secondary">
          ...
          <div className="picasso-feature-outro"><div className="picasso-meta">PICASSO AND PAUL SMITH.<br />THE NATIONAL ART CENTER, TOKYO, JAPAN.<br />SUMMER 2026.</div><p>Forget polite walls, mi gente. This show talks back to you, and Picasso is thrilled to argue right back. That's the whole reason to go and see it for yourself.</p></div>
        </div>
      </section>
